...
<a href="${ pageContext.request.contextPath }/JSP/User/UpdateUser.jsp"
	...
	<ul>
		<li><a href="${ pageContext.request.contextPath }/JSP/User/UpdateUser.jsp"
	rel="#overlay">Update User Details</a></li>
		<li><a href="javascript:void(0);" onclick="upload();">Upload Photo</a></li>
		<li><a href="${ pageContext.request.contextPath }/JSP/User/UpdateProfile.jsp">Change Password</a></li>
